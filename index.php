...
<body>
    <div class="container mt-4">
        <div class="container-box custom-border mt-4">
            ...
            <div>
                <button id="copiarNombre" class="btn btn-warning m-4 p-2 text-large"
                    style="display: none;">Copiar Nombre</button>
                <button id="copiarDNI" class="btn btn-info m-4 p-2 text-large"
                    style="display: none;">Copiar DNI</button>
            </div>
        </div>
    </div>
